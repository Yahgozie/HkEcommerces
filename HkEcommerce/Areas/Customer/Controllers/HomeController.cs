...
namespace HkEcommerce.Controllers
{
	[Area("Customer")]
	public class HomeController : Controller
	{
		...
		public IActionResult Index()
		{
			...
			//The logic for retrieving the user that logged into the application
		...
		//Creating the detail page of your site
		[HttpGet]
		...
		[Authorize]
		public IActionResult Detail(ShoppingCart CartObject)
		{
			CartObject.Id = 0;
			if (ModelState.IsValid)
			{
				...
				if (cartFromDb == null)
				{
					//No product exist in the database for that user
				...
				_unitOfWork.Save();
				//Using session in the application
				var count = _unitOfWork.ShoppingCart
			...
			{
				//if modelstate is not valid we will return back to the view
